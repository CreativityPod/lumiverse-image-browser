...
check(!frontend.includes('crypto.randomUUID'), 'frontend startup must work outside secure browser contexts')
check(frontend.includes("typeof ctx.ui.registerInputBarAction === 'function'"), 'input bar action must be optional')
